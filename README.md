...
The objective of the game is to guess a determined *secret word*. The player inputs a word, and if the *secret word*:
...
The game ends if:
* The player correctly guesses the *secret word*.
